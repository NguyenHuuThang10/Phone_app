                ...
                <div class="row">
                    <div class="span12">
                        <ul class="breadcrumb">
                            ...
                            <li><span class="icon-chevron-right"></span></li>
                            <li>
                                <a href="shop-no-sidebar.php">All Products (no sidebar)</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <section class="span12">
                        ...
                        <div class="row popup-products">
                            <?php
                                $p->xuatdanhsach_full("select * from sanpham order by id asc");
                            ?>
                        </div>
                        <hr />
    ...
    <a href="#" id="toTheTop">
        ...
        <div id="loginModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel"
            ...
            <div class="modal-header">
                ...
                <h3 id="loginModalLabel"><span class="light">Login</span> To Kết nối thế giới</h3>
            </div>
