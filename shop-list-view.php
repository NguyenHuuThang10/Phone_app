...
<!-- Mirrored from www.proteusthemes.com/themes/webmarket-html/shop-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Aug 2015 15:43:09 GMT -->

<head>
    <meta charset="utf-8">
    <title>Kết Nối Thế Giới | Liệt kê sản phẩm</title>
            ...
            <div class="push-up blocks-spacer">
                <div class="row">
                    ...
                    <section class="span9">
                            ...
                            <div class="row">
                                ...
                                <div class="span5 align-right">
                                    ...
                                    <div class="view-switch">
                                        <a href="shop.php" class="btn"><i class="icon-th"></i></a>
                                        <a href="shop-list-view.php" class="btn btn-primary"><i
                                                class="icon-list"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <?php
                                $p->xuatdanhsach_list("select * from sanpham order by id asc");
                            ?>
                        </div>
                        <hr />
                    </section>
