...
<head>
    <meta charset="utf-8">
    <title>Kết Nối Thế Giới | Liên hệ</title>
            ...
            <div class="row">
                ...
                <div class="span12">
                    <div class="title-area">
                        <h1 class="inline"><span class="light"></span> Liên hệ với chúng tôi</h1>
                    </div>
                </div>
                ...
                <section class="span8 single single-page">
                    ...
                    <article class="post">
                        <div class="post-inner">
                            <p>
                                Vui lòng nhập vào form dưới đây nếu bạn có thắc mắc hoặc đóng góp ý kiến với chúng tôi
                            </p>
                        </div>
                    </article>
                    <hr />
                    ...
                    <section class="contact-form-container">
                        <h3 class="push-down-25"><span class="light"></span>Form Thông Tin</h3>
                        <form id="commentform" method="post" action="#" class="form form-inline form-contact">
                            ...
                            <p class="push-down-20">
                                <textarea class="input-block-level" tabindex="4" rows="7" cols="70" id="comment"
                                    name="comment" placeholder="Your Message goes here ..." required></textarea>
                            </p>
                            <p>
                                <button class="btn btn-primary bold" type="submit" tabindex="5" id="submit">SEND
                                    EMAIL</button>
                            </p>
                        </form>
                    </section>
