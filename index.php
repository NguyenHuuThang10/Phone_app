...
<head>
    <meta charset="utf-8">
    <title>Kết Nối Thế Giới | Trang chủ</title>
    ...
    <div class="master-wrapper">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="higher-line">
                                Wellcome! Please
                                <a href="#registerModal" role="button" data-toggle="modal">Đăng kí</a> or
            ...
            <div class="fullwidthbanner">
                <ul>
                    <li data-transition="premium-random" data-slotamount="3">
                        <img src="images/dummy/slides/1/nen.jpg" alt="slider img" width="1400" height="377" />
                    </li>
                    <li data-transition="premium-random" data-slotamount="3">
                        <img src="images/dummy/slides/2/Tab_S7.webp" alt="slider img" width="1400" height="377" />
                    </li>
                    <li data-transition="premium-random" data-slotamount="3">
                        <img src="images/dummy/slides/3/1.jpg" alt="slider img" width="1400" height="377" />
                    </li>
                    <li data-transition="premium-random" data-slotamount="3">
                        <img src="images/dummy/slides/4/1.jpeg" alt="slider img" width="1400" height="377" />
                    </li>
                </ul>
                    ...
                    <div class="row">
                            <div class="span4">
                                <a href="#" class="btn btn-block banner">
                                    <span class="title"><span class="light"></span> Siêu sale đông về</span>
                                    <em>Giảm tới 30%</em>
                                </a>
                            </div>
                            <div class="span4">
                                <a href="#" class="btn btn-block colored banner">
                                    <span class="title"><span class="light"></span>Miễn phí vận chuyển</span>
                                    <em>Miễn phí vẫn chuyển cho đơn hàng từ 5 triệu đồng</em>
                                </a>
                            </div>
                            <div class="span4">
                                <a href="#" class="btn btn-block banner">
                                    <span class="title"><span class="light"></span>Sản phẩm mới</span>
                                    <em>Sản phẩm mới sẽ không làm quý khách thất vọng</em>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row featured-items blocks-spacer">
                <div class="span12">
                    ...
                    <div class="main-titles lined">
                        <h2 class="title"><span class="light"></span>Sản phẩm nổi bật</h2>
                        <div class="arrows">
                ...
                <div class="span12">
                    ...
                    <div class="carouFredSel" data-autoplay="false" data-nav="featuredItems">
                        <div class="slide">
                            <?php
                            $p->xuatdanhsachnoibat("select * from sanphamnoibat where id < 4 order by id asc");
                        ?>
                        </div>
                        <div class="slide">
                            <?php
                            $p->xuatdanhsachnoibat("select * from sanphamnoibat where id between 4 and 6 order by id asc");
                        ?>
                        </div>
                        <div class="slide">
                            <?php
                            $p->xuatdanhsachnoibat("select * from sanphamnoibat where id > 6 order by id asc");
                        ?>
                        </div>
        ...
        <div class="boxed-area blocks-spacer">
            <div class="container">
                ...
                <div class="row">
                    <div class="span12">
                        <div class="main-titles lined">
                            <h2 class="title"><span class="light"></span>Sản phẩm mới</h2>
                        </div>
                    </div>
                </div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <?php
                        $p->xuatdanhsach("select * from sanpham where id < 11 order by id asc");
                    ?>
        ...
        <div class="most-popular blocks-spacer">
            <div class="container">
                ...
                <div class="row">
                    <div class="span12">
                        <div class="main-titles lined">
                            <h2 class="title"><span class="light"></span>Sản phẩm phổ biến</h2>
                        </div>
                    </div>
                </div>

                <?php
                    $p->xuatdanhsachphobien("select * from sanphamphobien order by id asc");
                ?>
            </div>
        </div>
            ...
            <div class="row">
                <div class="span12">
                    <div class="brands  carouFredSel" data-nav="brands" data-autoplay="true">
                        <a href="http://www.samsung.com/"><img src="images/dummy/brands/ss.png" alt="" width="203"
                                height="104" /></a>
                        <a href="http://www.apples.com/"><img src="images/dummy/brands/ip.png" alt="" width="203"
                                height="104" /></a>
                        <a href="http://www.oppo.com/"><img src="images/dummy/brands/oppo.png" alt=""
                                width="203" height="104" /></a>
                        <a href="http://www.xiaomi.com/"><img src="images/dummy/brands/xiaomi.jpg" alt=""
                                width="203" height="104" /></a>
                        <a href="http://www.vivo.com/"><img src="images/dummy/brands/vivo.png" alt=""
                                width="203" height="104" /></a>
                        <a href="http://www.realme.com/"><img src="images/dummy/brands/realme.png" alt=""
                                width="203" height="104" /></a>
                        <a href="http://www.nokia.com/"><img src="images/dummy/brands/nokia.png" alt=""
                                width="203" height="104" /></a>
                        <a href="http://www.oneplus.com/"><img src="images/dummy/brands/1plus.png" alt=""
                                width="203" height="104" /></a>
                    </div>
                </div>
            </div>
        ...
        <div id="loginModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel"
            ...
            <div class="modal-header">
                ...
                <h3 id="loginModalLabel"><span class="light"></span>Đăng nhập</h3>
            </div>
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <button type="submit" class="btn btn-primary input-block-level bold higher" name="signin"
                        value="SIGN IN">
                        SIGN IN
                    </button>
                    <?php
        ...
        <div id="registerModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="registerModalLabel"
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 id="registerModalLabel"><span class="light"></span>Đăng kí tài khoản</h3>
            </div>
            <div class="modal-body">
                <form method="post" action="#">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-block-level" id="inputUsernameRegister" name="txtuser"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" class="input-block-level" id="inputPasswordRegister" name="txtpass"
                                placeholder="Password" required>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-danger input-block-level bold higher" name='dangki'
                    ...
                    <?php
						...
						switch($_POST['dangki'])
						{
							case 'REGISTER':
							{
								if($p->themxoasua("INSERT INTO taikhoan(username, password, email) VALUES ('$user', sha1('$pass'), '$email')") == 1)
								{
                                    echo '<script type="text/javascript">
                                            alert("thành công");
                                            </script>'
